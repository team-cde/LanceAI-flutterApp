...
class FeedbackOverlayState extends State<FeedbackOverlay> with SingleTickerProviderStateMixin {
      ...
      child: new InkWell(
        ...
        child: new Column(
          ...
          children: <Widget>[
            ...
            new Text(widget._isCorrect == true ? "Accepted!" : "Rejected!", style: new TextStyle(color: Colors.white, fontSize: 40.0)),
            new Text("Let Lance know why...", style: new TextStyle(color: Colors.white, fontSize: 25.0)),
